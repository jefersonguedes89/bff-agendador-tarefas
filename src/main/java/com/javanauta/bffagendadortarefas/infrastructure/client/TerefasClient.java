...
@FeignClient(name = "agendador", url = "${agendador-tarefas.url}")
public interface TerefasClient {
    ...
    @GetMapping
    List<TarefasDTOResponse> buscarListaDeTarefasPorEmail(@RequestHeader("Authorization") String token);
